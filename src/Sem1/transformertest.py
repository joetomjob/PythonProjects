...
def main():
    # f = input('Enter the message filename: ')
    # g = input('Enter the transform filename: ')
    x = input('Enter the string: ')
    op = input('Enter the operations to be performed: ')
    ende = input('Encryption or decryption to be performed (E/N): ')
